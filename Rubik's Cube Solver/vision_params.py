...
# black-filter
rgb_L = 80  # threshold for r, g and b values. rgb-pixels with r,g,b< rgb_L are consider to be no facelet-pixel
...
orange_L = 2  # lowest allowed hue for color orange
orange_H = 30  # highest allowed hue for color orange
yellow_H = 50  # highest allowed hue for color yellow
green_H = 100  # highest allowed hue for color green
blue_H = 140  # highest allowed hue for color blue
